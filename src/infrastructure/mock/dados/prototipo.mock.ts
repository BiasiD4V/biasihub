/**
 * @bridge Dados legados para as páginas de protótipo (src/pages/).
 * Usa os tipos de src/types/index.ts — mantidos enquanto as páginas
 * não forem migradas para o domínio novo.
 * Substituirá mockData.ts como fonte de dados das páginas atuais.
 */
...
export const mockPrototipoOrcamentos: Orcamento[] = [
  {
    id: '1',
    numero: 'ORC-2024-001',
    cliente: clientes[0],
