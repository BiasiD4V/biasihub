...
export interface BiraTarefa {
  ...
  bug_causa: string | null;
  bug_resolucao: string | null;
  bug_modulo: string | null;
  bug_documentado_em: string | null;
}
...
export const biraRepository = {
  ...
  async deletar(id: string): Promise<void> {
    // Primeiro deleta os comentários associados para evitar erro de chave estrangeira
    await supabase
      .from('bira_comentarios')
      .delete()
      .eq('tarefa_id', id);
