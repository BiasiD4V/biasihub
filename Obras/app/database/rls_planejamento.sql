-- ============================================================================
-- RLS POLICIES: Planejamento — Acesso por Obra e Papel
-- ============================================================================
-- Status: Deve ser executado após schema_planejamento.sql
-- Autenticação: Usa auth.uid() do Supabase Auth
-- Hierarquia de Acesso:
--   admin/diretor/gerente: Todas as obras
--   planejamento/supervisor/visualizador: Apenas obras vinculadas via usuario_obra
-- ============================================================================
...
RETURNS BOOLEAN AS $$
BEGIN
  -- Admin/Diretor/Gerente/Planejamento acessam (seus respectivos níveis) + Supervisor por vinculação
  IF EXISTS (
...
-- UPDATE: Apenas admin/planejamento
...
-- COMMENTS
-- ============================================================================
COMMENT ON FUNCTION public.usuario_pode_acessar_obra(UUID) IS
'Verifica se usuário autenticado tem acesso à obra: admin/diretor/gerente → todas; demais → via usuario_obra';
