...
export default function Header() {
  ...
  return (
    <header className="flex items-center px-6 flex-shrink-0 transition-all duration-300"
      style={{
        height: '56px',
        background: 'linear-gradient(135deg, #102556 0%, #0B1F49 100%)',
        borderBottom: '1px solid #2E4F8E',
        position: 'relative',
        zIndex: 40,
        boxShadow: '0 8px 24px rgba(2,7,23,0.35)'
      }}>
      ...
      <div className="flex items-center gap-2.5 flex-shrink-0">
        ...
        <div>
          <h1 className="text-sm font-bold" style={{ color: '#FFFFFF' }}>PCO</h1>
          <p className="text-[9px] leading-tight font-medium" style={{ color: '#AFC3EE' }}>Planejamento e Controle de Obras</p>
        </div>
      </div>

      {/* Separador visual */}
      <div className="hidden sm:block mx-4" style={{ width: '1px', height: '28px', backgroundColor: '#1D3569' }}></div>

      {/* Página atual (apenas em telas maiores) */}
      <div className="hidden sm:flex items-center flex-1">
        <p className="text-xs" style={{ color: '#DCE8FF' }}>{titulo !== 'Bem-vindo ao ERP Obras' ? titulo : 'Bem-vindo'}</p>
      </div>
      ...
      <div className="flex items-center gap-2 ml-3">
        ...
        <button onClick={toggleSidebar}
          ...
          style={{ color: '#DCE8FF', backgroundColor: '#1D3569' }}
          onMouseEnter={e => { e.currentTarget.style.backgroundColor = '#2A4888'; e.currentTarget.style.transform = 'translateY(-1px)' }}
          onMouseLeave={e => { e.currentTarget.style.backgroundColor = '#1D3569'; e.currentTarget.style.transform = 'translateY(0)' }}
          title="Menu">
          <Menu size={16} />
        </button>
        ...
        <div ref={refNotif} className="relative">
          <button onClick={() => { setAbrirNotif(v => !v); setAbrirUser(false) }}
            ...
            style={{
              color: abrirNotif ? '#d97706' : '#DCE8FF',
              backgroundColor: abrirNotif ? '#fef3c7' : '#1D3569',
              transform: 'translateY(0)'
            }}
            onMouseEnter={e => { e.currentTarget.style.backgroundColor = '#2A4888'; e.currentTarget.style.transform = 'translateY(-1px)' }}
            onMouseLeave={e => { e.currentTarget.style.backgroundColor = abrirNotif ? '#fef3c7' : '#1D3569'; e.currentTarget.style.transform = 'translateY(0)' }}>
            <Bell size={16} />
            {naoLidas > 0 && (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-xs font-semibold leading-tight" style={{ color: '#FFFFFF' }}>{n.titulo}</p>
        ...
        <div ref={refUser} className="relative pl-2" style={{ borderLeft: '1px solid #e2e8f0' }}>
          <button
            ...
            style={{ backgroundColor: '#1D3569', transform: 'translateY(0)' }}
            onMouseEnter={e => { e.currentTarget.style.backgroundColor = '#2A4888'; e.currentTarget.style.transform = 'translateY(-1px)' }}
