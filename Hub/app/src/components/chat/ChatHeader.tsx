          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {quemDigitando ? (
                ...
                <span className="text-[10px] font-black text-slate-300 uppercase tracking-widest">{dmAtivo.esta_online ? 'Online agora' : formatUltimoVisto(dmAtivo.ultimo_visto)}</span>
              )}
            </div>
          </div>
        ) : (
