      ...
      {canalGeral && (
        <div className="space-y-3">
          ...
          >
            ...
            {geralNaoLida && <div className="w-3 h-3 rounded-full bg-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.5)] animate-pulse" />}
          </button>
        </div>
      )}
      ...
      {(canaisSetor.length > 0 || canaisGrupo.length > 0) && (
        <div className="space-y-4">
          <div className="flex items-center justify-between ml-2">
            ...
            <button onClick={onCriarGrupo} className="w-6 h-6 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white flex items-center justify-center transition-all">
              <Plus size={14} />
            </button>
          </div>
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center justify-between mb-0.5">
                  ...
                  {naoLidasPorConta.has(m.id) && <div className="px-2 py-0.5 rounded-lg bg-indigo-500 text-white text-[8px] font-black uppercase shadow-lg shadow-indigo-500/20">Novo</div>}
                </div>
